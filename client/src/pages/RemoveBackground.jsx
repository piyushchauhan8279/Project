  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] px-4 py-2 mt-6 text-sm rounded-b-lg cursor-pointer text-white ">
